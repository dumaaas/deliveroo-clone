    ...
    <>
      ...
      <ScrollView>
        <View className="relative">
          ...
          <TouchableOpacity onPress={navigation.goBack} className="absolute p-2 bg-gray-100 rounded-full top-14 left-5">
        ...
        <View className="pb-36">
          <Text className="px-4 py-6 text-xl font-bold">Menu</Text>
          {/* Dishrows */}
          {dishes.map((dish) => (
            <DishRow 
              key={dish._id}
